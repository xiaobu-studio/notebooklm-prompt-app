...
2. **第二步完整性**：第二步的所有內容（包含指令與後面的簡報大綱預覽）必須「連在一起」，中間嚴禁出現 "---"，確保使用者能一次複製到底。
3. **專業排版樣式**：
...
### 📥 第一步：探索與搜尋資料源的提示詞
你現在是一位數位內容創作專家。請針對「${topic}」主題，為「${audience}」受眾搜尋並整理出高品質的來源資料。
...
**預期目標：**
* 請 NotebookLM 整理出具體的數據、工具清單或實際應用情境。
...
---
(這裡緊接著輸出「簡報大綱預覽」，不要再加分隔線，確保整塊可以一次被複製)`,
        });
